...
class LayerList extends React.Component<IProps, IState> {
    ...
    render() {
        ...
        const {
            layerAct: { selected, hovered, focusId },
                            ...
                            >
                                {focusId === item.id ? (
                                    <AliasInput
                                        ...
                                        changeLayerFocus={this.changeLayerFocus}
                                    />
                                ) : (
                                    <span
                                        className={styles['layer-item-span']}
                                        onDoubleClick={() => this.changeLayerFocus(item.id)}
                                    >{currLayer.alias}
                                    </span>
                                )}
                            </div>
    ...
    changeLayerVisible = (e: any, id: string) => {
        const { config: { layers } } = this.props.store;
        e.stopPropagation();
        this.props.store.changeLayerConfig({
            ...
            data: {
                ...
                opLayers: [id],
                value: {
                    visible: !layers[id].attr.visible
                }
            }
        });
    }
