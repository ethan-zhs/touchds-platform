...
class EditorRuler extends React.Component<IRulerProps, IRulerState> {
    ...
    render() {
        ...
        return (
            <div className={styles['datat-ruler']} id='datatRuler'>
                {rulerArr.map((ruler, rulerIndex) => (
                    <div
                        key={rulerIndex}
                        className={[styles['ruler-wrapper'], styles[`${ruler.type}-container`]].join(' ')}
                        style={{
    ...
    drawSingleRuler = (currRuler: any, options: any, percent: number) => {
        ...
        switch (true) {
            case percent < 10: baseLabel = 1600; break;
            case percent >= 10 && percent < 12: baseLabel = 1400; break;
            case percent >= 12 && percent < 14: baseLabel = 1200; break;
            case percent >= 14 && percent < 17: baseLabel = 1000; break;
            case percent >= 17 && percent < 35: baseLabel = 800; break;
            case percent >= 35 && percent < 52: baseLabel = 400; break;
            case percent >= 52 && percent < 88: baseLabel = 200; break;
            case percent >= 88 && percent < 105: baseLabel = 160; break;
            case percent >= 105 && percent < 140: baseLabel = 120; break;
            case percent >= 140: baseLabel = 80; break;
        }
