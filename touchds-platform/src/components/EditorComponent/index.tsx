...
class DatatEditorComponent extends React.Component<IComProps, any> {
    ...
    render() {
        ...
        return (
            <div className={[styles['datat-editor-component'], !visible ? styles['__hide'] : ''].join(' ')} >
                <div className={styles['component-panel']}>
                    <div className={styles['component-head']}>
                        <span>组件列表</span>
                        <i className='icon-font icon-back' onClick={() => this.props.changePanelVisible('component')} />
                    </div>
...
export default DatatEditorComponent;
